...
namespace Client.Pages.Admin.Identity
{
    public partial class Users
    {
        ...
        {
            _navigationManager.NavigateTo($"/admin/identity/user-roles/{userId}");
        }
    }
}
