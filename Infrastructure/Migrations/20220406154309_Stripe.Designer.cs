...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20220406154309_Stripe")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Stripe.StripeCheckout", b =>
                {
                    ...
                    b.Property<string>("IdStripeCheckoutId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("IdStripeCheckoutId");

                    b.HasIndex("SimtrixxUserId");

                    b.ToTable("StripeCheckout");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Stripe.StripeCustomer", b =>
                {
                    ...
                    b.Property<string>("IdStripeCustomerId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Domain.Entities.Stripe.StripeOrder", b =>
                {
                    ...
                    b.Property<string>("IdStripeOrderId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<int>("StripeCheckoutId")
                        .HasColumnType("int");

                    b.Property<string>("StripeCheckoutId1")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("StripeCustomerId1")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("StripeSubscriptionId1")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("StripeOrderId");

                    b.HasIndex("IdStripeOrderId");

                    b.HasIndex("LicenseId");

                    b.HasIndex("SimtrixxUserId");

                    b.HasIndex("StripeCheckoutId1");

                    b.HasIndex("StripeCustomerId1");

                    b.HasIndex("StripeSubscriptionId1");
            ...
            modelBuilder.Entity("Domain.Entities.Stripe.StripeSubscription", b =>
                {
                    ...
                    b.Property<string>("IdStripeSubscriptionId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("IdStripeSubscriptionId");
            ...
            modelBuilder.Entity("Domain.Entities.Stripe.StripeCheckout", b =>
                {
                    b.HasOne("Domain.Entities.Stripe.StripeCheckout", "Id")
                        .WithMany()
                        .HasForeignKey("IdStripeCheckoutId");
            ...
            modelBuilder.Entity("Domain.Entities.Stripe.StripeCustomer", b =>
                {
                    b.HasOne("Domain.Entities.Stripe.StripeCustomer", "Id")
                        .WithMany()
                        .HasForeignKey("IdStripeCustomerId");
            ...
            modelBuilder.Entity("Domain.Entities.Stripe.StripeOrder", b =>
                {
                    b.HasOne("Domain.Entities.Stripe.StripeOrder", "Id")
                        .WithMany()
                        .HasForeignKey("IdStripeOrderId");
                    ...
                    b.HasOne("Domain.Entities.Stripe.StripeCheckout", "StripeCheckout")
                        .WithMany()
                        .HasForeignKey("StripeCheckoutId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("Domain.Entities.Stripe.StripeSubscription", "StripeSubscription")
                        .WithMany()
                        .HasForeignKey("StripeSubscriptionId1");
            ...
            modelBuilder.Entity("Domain.Entities.Stripe.StripeSubscription", b =>
                {
                    b.HasOne("Domain.Entities.Stripe.StripeSubscription", "Id")
                        .WithMany()
                        .HasForeignKey("IdStripeSubscriptionId");
