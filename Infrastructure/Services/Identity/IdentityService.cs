...
namespace Infrastructure.Services.Identity
{
    public class IdentityService : ITokenService
    {
        ...
        public IdentityService(
            UserManager<SimtrixxUser> userManager, RoleManager<SimtrixxRole> roleManager,
            IOptions<AppConfiguration> appConfig, SignInManager<SimtrixxUser> signInManager)
        {
        ...
        private async Task<string> GenerateJwtAsync(SimtrixxUser user)
        {
            var token = GenerateEncryptedToken(GetSigningCredentials(), await GetClaimsAsync(user));
            return token;
        }

        private async Task<IEnumerable<Claim>> GetClaimsAsync(SimtrixxUser user)
        {
