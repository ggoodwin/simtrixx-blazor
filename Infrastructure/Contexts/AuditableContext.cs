...
{
    public abstract class AuditableContext : IdentityDbContext<SimtrixxUser, SimtrixxRole, string, IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, SimtrixxRoleClaim, IdentityUserToken<string>>
    {
